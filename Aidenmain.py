...
RSAPubKey = "<RSAKeyValue><Modulus></Modulus><Exponent>AQAB</Exponent></RSAKeyValue>"# ENTER RSAKEY
auth = "WyIxMDc5MDkxNjkiLCI5RldqeUNSaWlzbVM2TE1FdVE2STFPeWxvZUtHRTRmSWN6SG1hWHYvIl0=" ## AUTHKEY WITH ACTIVATE !
def Authkey():
...
def banner(console):
    ...
    brand_name = " JHON AIDEN VIP V6.0\n"
    colors = [
...
def load_player_data(cpm):
    ...
    if response.get('ok'):
        ...
        if 'floats' in data and 'localID' in data and 'money' in data and 'coin' in data:
            ...
            console.print(f"[bold white]  >> Cars        : {car_count}[/bold white]")
...
def load_key_data(cpm):
    ...
    #console.print(f"[bold white]  >> Access Key  [/bold white]: [yellow]{data.get('access_key')}[/yellow]")
...
if __name__ == "__main__":
    ...
    while True:
        ...
        while True:
            ...
            console.print("[bold cyan][bold white](50)[/bold white]: Custom HP  All  Cars           [bold red]2.5K[/bold red][/bold cyan]")
            console.print("[bold cyan][bold white](51)[/bold white]: Login Another Account          [bold red]Free[/bold red][/bold cyan]")
            console.print("[bold cyan][bold white](0) [/bold white]: Exit From AidenTool [/bold cyan]")
            
            console.print("[bold red]===============[bold white][ ᗩIᗪEᑎ ᑭOGI ][/bold white]===============[/bold red]")
